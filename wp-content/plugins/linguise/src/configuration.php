    ...
    public function renderSettings()
    {
        ...
        if (isset($_POST['linguise_options'])) {
            ...
            if ($old_options['token'] !== $token && $token !== '') {
                ...
                $result =  wp_remote_get('https://api.linguise.com/api/config', $args);
            ...
            $linguise_options = array(
                ...
                'flag_shadow_h' => isset($_POST['linguise_options']['flag_shadow_h']) ? (int)$_POST['linguise_options']['flag_shadow_h'] : 3,
                'flag_shadow_v' => isset($_POST['linguise_options']['flag_shadow_v']) ? (int)$_POST['linguise_options']['flag_shadow_v'] : 3,
                'flag_shadow_blur' => isset($_POST['linguise_options']['flag_shadow_blur']) ? (int)$_POST['linguise_options']['flag_shadow_blur'] : 6,
                'flag_shadow_spread' => isset($_POST['linguise_options']['flag_shadow_spread']) ? (int)$_POST['linguise_options']['flag_shadow_spread'] : 0,
                'flag_shadow_color' => isset($_POST['linguise_options']['flag_shadow_color']) ? $_POST['linguise_options']['flag_shadow_color'] : '#bfbfbf',
