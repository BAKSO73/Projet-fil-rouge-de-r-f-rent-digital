...
<div class="content">
    ...
    <div class="linguise-settings-option full-width">
        ...
        <p class="linguise_note"><?php echo sprintf(esc_html__('Note that adding or removing languages won\'t apply as the language configuration is made from the %s only.', 'linguise'), '<a target="_blank" href="https://dashboard.linguise.com/">'. esc_html__('Linguise dashboard', 'linguise') .'</a>'); ?></p>
        <p class="linguise_note"><?php esc_html_e('Please update the domain configuration from the dashboard and save the plugin settings again, thanks! :)', 'linguise') ?></p>
    </div>
    <div class="linguise-settings-option full-width">
                ...
                <ul>
                    ...
                    <li>
                        <div class="linguise-switch-button">
                            ...
                            <label for="id-language_name"><?php esc_html_e('Language Name', 'linguise'); ?></label>
                        </div>
                    </li>
                </ul>
            </div>
