	...
	function nfproot_settings_callback() {	
		...
		if(!empty($nfproot_plugins_settings)) {
			...
			<div class="wrap nfproot-settings-wrap">
				...
				<h1>NutsForPress</h1>
				<h2><?php echo __('Installed Plugins','nfprootlang'); ?></h2>
				<p>
				<ul>
			...
			?>
				...
				<div style="margin-top:150px">
					...
					<h4><?php echo __('Take a look to the others','nfprootlang'); ?> <a href="https://it.wordpress.org/plugins/search/nutsforpress/" title="<?php echo __('NutsForPress Plugins','nfprootlang'); ?>" alt="<?php echo __('NutsForPress Plugins','nfprootlang'); ?>" target="_blank"><?php echo __('NutsForPress Plugins','nfprootlang'); ?></a></h4>
