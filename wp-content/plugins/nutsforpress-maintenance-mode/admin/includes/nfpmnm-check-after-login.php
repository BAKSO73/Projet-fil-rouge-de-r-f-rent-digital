			...
			if($nfpmnm_can_login_on_maintenance !== '1'){
				...
				if(in_array('administrator', $nfpmnm_user_roles)){
					...
					if(
						...
						$nfpmnm_logout_message = __('Until Maintenance Mode is active, only these Administrators are allowed to login', 'nfpmnmlang').':';
					...
					//if current user is not an Administratore, display a generci message
					$nfpmnm_logout_message = __('Until Maintenance Mode is active, you are not allowed to login', 'nfpmnmlang');
