...
Description: 	NutsForPress Maintenance Mode a simple and lightweight plugin that allows to activate a maintenance mode and redirect not logged users to a defined page.
Version:     	1.1
Author:			Christian Gatti
Author URI:		https://profiles.wordpress.org/christian-gatti/
License:		GPL-2.0+
License URI:	http://www.gnu.org/licenses/gpl-2.0.txt
Text Domain:	nfpmnmlang
...
//load NutsForPress languages
require_once NFPMNM_BASE_PATH.'root/nfproot-load-languages.php';
add_action('plugins_loaded', 'nfproot_load_languages');	
...
//load languages
require_once NFPMNM_BASE_PATH.'includes/nfpmnm-load-languages.php';
add_action('plugins_loaded', 'nfpmnm_load_languages');
